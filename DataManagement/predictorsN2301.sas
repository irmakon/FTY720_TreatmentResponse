...
data demo;
    set n2301.a_dmg (keep = stysid1a TRTREG1C SEX1C BMI_1N RCE5C age_1n_cat);
...
data ident;
    set n2301.a_ident (keep = stysid1a trtn priorms TGPDSC1A);
	rename priorms = PriorMSDr trtn = Drug;
run;

data edss;
    set n2301.a_edss (keep = stysid1a vis1n EXDSC1NB FUNBOW1N FUNBRA1N FUNCER1N FUNMEN1N FUNPYR1N
                             FUNSEN1N FUNVSU1N);
...
data mri;
    set n2301.a_mri (keep = vis1n stysid1a NUMGD1BA TVOLGDBA TVOLT2BA TVT1HIBA);
...
data mshis;
    set n2301.a_mshis (keep = stysid1a vis1n DURMS1 NUMRLP2N RELTIME);
	where vis1n = 1; *screening;
...
data mshis2;
    set n2301.a_mshis (keep = STYSID1A vis1n prvtmt8c prvtmt3c);
	where vis1n = 1;
	format _all_;
run;
...
/*
data lrs;
    set n2301.a_lrs (keep = stysid1a vis1n blflg_1c CV_BL_1N PARNAM1C CVUNT_1C LABCAT1C);
...
data lrs99;
    set n2301.a_lrs (keep = stysid1a CV_BL_1N PARNAM1C);
...
data unique;
    set n2301.a_lrs (keep = PARNAM1C CVUNT_1C LABCAT1C);
	format _all_;
run;
...
*/
data lrs;
    set n2301.a_lrs (keep = stysid1a CV_BL_1N PARNAM1C CVUNT_1C LABCAT1C);
	where CV_BL_1N ne . and 
	      PARNAM1C in ("ABSBAS","ABSEOS","ABSLYM","ABSMON","ABSNEU","ALB","ALKPHS","CREA","DBIL",
                       "GGT","MCH","MCV","PT","SGOT","SGPT","TBIL","UPROTST","WBC");
	format _all_;
...
%macro renamelab(ds);
    data &ds.2;
    set &ds.;
    %let lab_list = ABSBAS ABSEOS ABSLYM ABSMON ABSNEU ALB ALKPHS CREA DBIL GGT MCH MCV PT SGOT SGPT TBIL UPROTST WBC
                    ;
	%let b=1;
...
data lrs_ct3;
	length ABSBAS ABSEOS ABSLYM ABSMON ABSNEU ALB ALKPHS CREA DBIL GGT MCH MCV PT SGOT SGPT TBIL UPROTST WBC $10.;
...
data qol;
    set n2301.a_qol (keep = stysid1a vis1n pag1a ACT4C ANX1C MOB1C PAI4C SFC1C VASBL);
...
data msfc;
    set n2301.a_msfc (keep = stysid1a VIS1N HPTBL PASATBL T25FWBL);
	where vis1n = 2; *baseline;
...
/*
data cnd99;
    set n2301.a_cnd (keep = stysid1a SOC_ABBR ACTPRB1C SOC_TXT); * SOC_CODE = "" fuer alle;
...
data cm;
    set n2301.a_cmdatc (keep = stysid1a CONCTIM ATCCODE);
